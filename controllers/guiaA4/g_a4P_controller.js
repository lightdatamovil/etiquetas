...
//! GUIA A4 PREMIUM--------------------------------------------------------------
const ga4P = async (doc, objData, distanciaAlto) => {
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoDesde, anchoContainerDesde, altoContainerDesde, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoRem, anchoContainerDesde, altoContainerRem, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(anchoTotalPagina / 2 + distanciaAncho - 6, distanciaAltoDesde, anchoContainerDesde, altoContainerDesde, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(anchoTotalPagina / 2 + distanciaAncho - 6, distanciaAltoRem, anchoContainerDesde, altoContainerRem, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoCDV, anchoContainerCDV, altoContainerCDV, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoBultos, anchoContainerBultos, altoContainerBultos, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoFirmas, anchoContainerFirmas, altoContainerFirmas, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    //! FIRMA DESTINATARIO--------------------------------------------------------------
    doc.roundedRect(distanciaAnchoFirmas, distanciaAltoFirmas, anchoContainerFirmas, altoContainerFirmas, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAncho, distanciaAltoObs, anchoContainerObs, altoContainerObs, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
    ...
    doc.roundedRect(distanciaAnchoListado, distanciaAltoListado, anchoContainerListado, altoContainerListado, 5).fillAndStroke(colorGrisClaro, colorGrisClaro)
