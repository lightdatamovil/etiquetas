...
//ETIQUETA 10x5 CON SOLO

const e10x5S = async ({ doc, objData, llevaCodigo }) => {
    ...
    for (let i = 0; i < bultos; i++) {
        ...
        doc.moveTo(distanciaAncho2, containerSiguiente2(0) - 3)
            ...
            .fill(colorGrisOscuro)
        doc.moveTo(distanciaAncho2 + anchoContainer2, containerSiguiente2(0) - 3 + 3)
            .lineTo(distanciaAncho2 + anchoContainer2, containerSiguiente2(1) - 3 - 3)
            .fill(colorGrisOscuro)
        ...
        SVGtoPDF(doc, iconTelefono, posicionAnchoTexto2 + anchoContainer2, posicionAltoTexto2(0) - 5)

        let tamañoNumero = tamañoSegunLargo(nroTelefono, tamañoFuente2, 24)
        doc.fontSize(tamañoNumero)
            .font("Helvetica-Bold")
            .text(esDatoValido(nroTelefono) ? cortarTexto(nroTelefono, 32) : "Sin información", posicionAnchoTexto2 + 15 + anchoContainer2, posicionAltoTexto2(0), { baseline: "middle", lineBreak: false })
        ...
        doc.fontSize(tamañoDireccion)
            .font("Helvetica-Bold")
            .text(`${esDatoValido(direccion) ? cortarTexto(direccion, 70) : "Sin información"} ${esDatoValido(cp) ? "CP: " + cp : ""}`, posicionAnchoTexto2 + 15, posicionAltoTexto2(1), { baseline: "middle", lineBreak: false })
